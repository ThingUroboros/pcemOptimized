...
ACLOCAL = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/missing autoconf
AUTOHEADER = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/missing autoheader
AUTOMAKE = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = pcem
...
WX_VERSION_MICRO = 4
WX_VERSION_MINOR = 0
abs_builddir = /media/martin/Elements/pcemforlinuxtest/newtest
abs_srcdir = /media/martin/Elements/pcemforlinuxtest/newtest
abs_top_builddir = /media/martin/Elements/pcemforlinuxtest/newtest
abs_top_srcdir = /media/martin/Elements/pcemforlinuxtest/newtest
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /media/martin/Elements/pcemforlinuxtest/newtest/install-sh
